  ...
  return (
    <Fragment>
      <div className="h-full text-body flex flex-col">
              ...
              <div className="flex-1 flex justify-center">
                <nav className="hidden lg:flex items-center space-x-4 text-xl">
                  <div className="relative group cursor-pointer">
                    ...
                    <a
                      href="#home"
                      className="relative z-10 text-white group-hover:text-gray-700 dark:text-white dark:group-hover:text-gray-300 transition-colors duration-300 px-4 py-2 block"
                    >
                      Trang chủ
                    </a>
                  </div>
                  <div className="relative group cursor-pointer">
                    <div className="absolute inset-0 bg-gray-100 opacity-0 group-hover:opacity-100 transition-opacity duration-300 border-2"></div>
                    <a
                      href="#about"
                      className="relative z-10 text-white group-hover:text-gray-700 dark:text-white dark:group-hover:text-gray-300 transition-colors duration-300 px-4 py-2 block"
                    >
        ...
        <main className="relative flex flex-col flex-1 items-center justify-center text-center px-4 py-24 sm:px-6 lg:px-8">
          <div className="mx-auto -mt-36 max-w-4xl px-1 sm:-mt-44 md:px-0 lg:-mt-56">
            <div className="rounded-xl bg-body shadow-xl xs:p-2 sm:p-2 bg-gray-500">
              <a
                className="relative block bg-neutral-100"
                href="https://clem.travelmap.net/cycling-around-australia"
                title="Open my TravelMap blog (new tab)"
                style={{ aspectRatio: "2" }}
                target="_blank"
              ...
              >
                <picture className="rounded-xl">
                  <source
                    srcSet="/images/mainpicturehome.png"
                    type="image/webp"
                  />
                  <img
                    className="block w-full rounded"
                    src="/images/mainpicturehome.png"
                    alt="Screenshot of the TravelMap interface with its interactive map and timeline"
                    style={{ aspectRatio: "2" }}
                    fetchpriority="high"
                  />
                </picture>

                <span className="absolute inset-0 grid place-items-center bg-white/30 opacity-0 transition-opacity hover:opacity-100">
                  <svg
                    width="42"
                    height="42"
                    viewBox="0 0 24 24"
                    ...
                    role="img"
                    aria-hidden="true"
                    className="svg-icon shrink-0 fill-current text-neutral-500"
                  >
        ...
        <footer class="bg-neutral-700 py-8 px-6 text-white sm:px-8">
          <div class="mx-auto flex max-w-4xl flex-row justify-between items-center gap-8">
